...
import com.bw.movie.adapter.HomeMoreHotAdapter;
 ...
 * Description:
 */
public class FragmentMoreHot extends BaseFragment implements HomeContract.IHomeView {
    @BindView(R.id.rv_home_more_hot)
    RecyclerView rv;
    Unbinder unbinder;
    ...
    protected int getLayout() {
        return R.layout.fragment_more_hot;
    }
    ...
    protected void initData() {
        ...
        if (netWork) {
            ...
            if (presenter instanceof HomeContract.IHomePresenter) {
                ((HomeContract.IHomePresenter) presenter).getHomeHotMovie(1, 10);
            }
        } else {
    ...
    public void onHomeHotMovieSuccess(HomeHotMovieBean homeHotMovieBean) {
        ...
        HomeMoreHotAdapter adapter = new HomeMoreHotAdapter(getActivity(), list);
