 ...
 * Description:
 */
public class HomeMoreHotAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    List<HomeHotMovieBean.ResultBean> list;


    public HomeMoreHotAdapter(Context context, List<HomeHotMovieBean.ResultBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int i) {
        HomeHotMovieBean.ResultBean bean = list.get(i);
